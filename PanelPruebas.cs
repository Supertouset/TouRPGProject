...
namespace TouRPGProject
{
    public partial class FormAlgoritmoRPG : Form
    {
        ...
        private void MostrarStats(Stats stats)
        {
        ...
        private void MostrarDatosPJ(PersonajeBase pj)
        {
        ...
        private void MostrarDatosEnemigo(PersonajeBase enemigoSeleccionado)
        {
        ...
        {
            //1: Generamos un item
            //Objeto nuevoItem = CalculosRPGItems.GenerarItemRandom();
