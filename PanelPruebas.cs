...
namespace TouRPGProject
{
    public partial class FormAlgoritmoRPG : Form
    {
        ...
        public Dictionary<string, string> listaHabilidadesItems = null;
        public List<Personaje> listaPersonajes = new List<Personaje>();
        public Personaje pjSeleccionado = null;
        public Personaje enemigoSeleccionado = null;
        public Item itemSeleccionado = null;

        //Variables Coliseo
        public List<Habilidad> listaHabsPersonajes = new List<Habilidad>();
        public List<PersonajeJugador> listaAspirantes = new List<PersonajeJugador>();
        public List<PersonajeEnemigo> listaEnemigos = new List<PersonajeEnemigo>();
        PersonajeJugador personajeJugadorElegido = null;
        PersonajeEnemigo PersonajeEnemigoElegido = null;
